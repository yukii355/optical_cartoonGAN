...
class Img2_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if idx == 6477:
            ...
            img1 = cv2.resize(cv2.imread(self.img_path + num1), (320, 180))
            img2 = cv2.resize(cv2.imread(self.img_path + num1), (320, 180))
            ...
            num2 = "%06d.jpg" %(idx + 2)
            img1 = cv2.resize(cv2.imread(self.img_path + num1), (320, 180))
            img2 = cv2.resize(cv2.imread(self.img_path + num2), (320, 180))
        ...
        ani = cv2.resize(cv2.imread(ani_path), (320, 180))
...
if __name__ == '__main__':
    img_path = "/home/moriyama/PycharmProjects/op_background/img2/"
